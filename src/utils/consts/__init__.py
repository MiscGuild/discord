...
from .discord_consts import (GVG_REQUIREMENTS, ERROR_CHANNEL_ID, DNKL_CHANNEL_ID, TICKET_CHANNEL_ID, LOG_CHANNEL_ID,
                             ...
                             PARTNER_CHANNEL_ID, QOTD_THREAD_ID,
                             GEOGUESSR_THREAD_ID, MILESTONES_CHANNEL_ID, WEEKLY_LB_CHANNEL_ID, DAILY_LB_CHANNEL_ID,
                             RANK_UPGRADE_CHANNEL_ID, TICKET_CATEGORIES, MILESTONE_CATEGORIES, MILESTONE_EMOJIS,
                             GUEST_TICKET_REASONS, MEMBER_TICKET_REASONS,
                             ...
                             DNKL_ENTRIES_NOT_FOUND, ONLINE_STATUS_EMOJIS,
                             INFORMATION_MESSAGE, INFORMATION_MESSAGE_2, INFORMATION_MESSAGE_3, RESIDENT_EMBED,
                             TICKETS_MESSAGES, GVG_INFO_EMBED, POSITIVE_RESPONSES, UNKNOWN_IGN_MSG, INVALID_DATE_MSG,
                             MISSING_ROLES_EMBED, MISSING_PERMS_MSG, INVALID_COMMAND_EMBED, NOT_OWNER_EMBED,
                             ...
                             REQUIREMENTS_TEXT, JOIN_REQUEST_EMBED, UNKNOWN_GUILD_EMBED, STAFF_APPLICATION_DENIAL,
                             DNKL_CREATION_EMBED, RULES_MESSAGES, RANK_UPGRADE_WINNER_MESSAGE,
                             STAFF_APPLICATION_QUESTIONS, SPOILERS_AHEAD, CLIP_SUBMISSION_TICKET)
