...
async def get_hypixel_player_rank(player_data):
    ...
    if "prefix" in player_data and player_data["prefix"] in [
        "§d[PIG§b+++§d]",
        "§c[SLOTH]",
        "§c[OWNER]",
    ]:
        return player_data["prefix"].replace("§", "&"), re.sub(
            r"(§.)", "", player_data["prefix"]
        )
        ...
        if rank == "VIP":
            ...
            if "monthlyPackageRank" in player_data:
                ...
                if "rankPlusColor" not in player_data:
                    return (
                        "&6[MVP&c++&6]"
                        if "monthlyRankColor" not in player_data
                        or player_data["monthlyRankColor"] == "GOLD"
                        else "&b[MVP&c++&b]",
                        "[MVP++]",
                    )
...
async def generate_lb_text(member_gexp: list, text: str):
    ...
    for uuid, gexp in member_gexp[:10]:
        ...
        rank, _ = await get_hypixel_player_rank(
            await get_hypixel_player(uuid=uuid)
...
async def get_points_from_data(start_data, end_data):
    ...
    games_played = end_data["games_played_bedwars"] - \
        start_data["games_played_bedwars"]
    wins = end_data["wins_bedwars"] - start_data["wins_bedwars"]
    bed_breaks_end = int(
        end_data["eight_one_beds_broken_bedwars"]
        + end_data["eight_two_beds_broken_bedwars"]
        + end_data["four_three_beds_broken_bedwars"]
        + end_data["four_four_beds_broken_bedwars"]
        + end_data["two_four_beds_broken_bedwars"]
    )
    bed_breaks_start = int(
        start_data["eight_one_beds_broken_bedwars"]
        + start_data["eight_two_beds_broken_bedwars"]
        + start_data["four_three_beds_broken_bedwars"]
        + start_data["four_four_beds_broken_bedwars"]
    ...
    final_kills = end_data["final_kills_bedwars"] - \
        start_data["final_kills_bedwars"]
    final_deaths = end_data["final_deaths_bedwars"] - \
        start_data["final_deaths_bedwars"]
    fkdr = round(final_kills / final_deaths,
                 2) if final_deaths != 0 else final_kills

    start_points = 0
    start_points += (
        end_data["total_challenges_completed"]
        - start_data["total_challenges_completed"]
    ) * 5

    start_points += (
        end_data["eight_one_final_kills_bedwars"]
        - start_data["eight_one_final_kills_bedwars"]
    ) * 30
    start_points += (
        end_data["eight_one_kills_bedwars"] -
        start_data["eight_one_kills_bedwars"]
    ) * 1
    start_points += (
        end_data["eight_one_beds_broken_bedwars"]
        - start_data["eight_one_beds_broken_bedwars"]
    ...
    start_points += (
        end_data["eight_one_wins_bedwars"] -
        start_data["eight_one_wins_bedwars"]
    ) * 40

    start_points += (
        end_data["eight_two_final_kills_bedwars"]
        - start_data["eight_two_final_kills_bedwars"]
    ) * 15
    start_points += (
        end_data["eight_two_kills_bedwars"] -
        start_data["eight_two_kills_bedwars"]
    ) * 1
    start_points += (
        end_data["eight_two_beds_broken_bedwars"]
        - start_data["eight_two_beds_broken_bedwars"]
    ...
    start_points += (
        end_data["eight_two_wins_bedwars"] -
        start_data["eight_two_wins_bedwars"]
    ) * 40

    start_points += (
        end_data["four_three_final_kills_bedwars"]
        - start_data["four_three_final_kills_bedwars"]
    ) * 20
    start_points += (
        end_data["four_three_kills_bedwars"] -
        start_data["four_three_kills_bedwars"]
    ) * 1
    start_points += (
        end_data["four_three_beds_broken_bedwars"]
        - start_data["four_three_beds_broken_bedwars"]
    ...
    start_points += (
        end_data["four_three_wins_bedwars"] -
        start_data["four_three_wins_bedwars"]
    ) * 30

    start_points += (
        end_data["four_four_final_kills_bedwars"]
        - start_data["four_four_final_kills_bedwars"]
    ) * 15
    start_points += (
        end_data["four_four_kills_bedwars"] -
        start_data["four_four_kills_bedwars"]
    ) * 1
    start_points += (
        end_data["four_four_beds_broken_bedwars"]
        - start_data["four_four_beds_broken_bedwars"]
    ...
    start_points += (
        end_data["four_four_wins_bedwars"] -
        start_data["four_four_wins_bedwars"]
    ) * 30

    start_points += (
        end_data["two_four_final_kills_bedwars"]
        - start_data["two_four_final_kills_bedwars"]
    ) * 20
    start_points += (
        end_data["two_four_kills_bedwars"] -
        start_data["two_four_kills_bedwars"]
    ) * 1
    start_points += (
        end_data["two_four_beds_broken_bedwars"]
        - start_data["two_four_beds_broken_bedwars"]
    ...
    start_points += (
        end_data["two_four_wins_bedwars"] - start_data["two_four_wins_bedwars"]
    ) * 20
...
async def get_game_data(bedwars_data):
    ...
    total_challenges_completed = (
        bedwars_data["challenges_completed_bedwars"]
        if "challenges_completed_bedwars" in bedwars_data
        else 0
    )
    games_played_bedwars = (
        bedwars_data["games_played_bedwars"]
        if "games_played_bedwars" in bedwars_data
        else 0
    )
    deaths_bedwars = (
        bedwars_data["deaths_bedwars"] if "deaths_bedwars" in bedwars_data else 0
    )
    wins_bedwars = bedwars_data["wins_bedwars"] if "wins_bedwars" in bedwars_data else 0
    final_kills_bedwars = (
        bedwars_data["final_kills_bedwars"]
        if "final_kills_bedwars" in bedwars_data
        else 0
    )
    final_deaths_bedwars = (
        bedwars_data["final_deaths_bedwars"]
        if "final_deaths_bedwars" in bedwars_data
        else 0
    )
    eight_one_final_kills_bedwars = (
        bedwars_data["eight_one_final_kills_bedwars"]
        if "eight_one_final_kills_bedwars" in bedwars_data
        else 0
    )
    eight_one_kills_bedwars = (
        bedwars_data["eight_one_kills_bedwars"]
        if "eight_one_kills_bedwars" in bedwars_data
        else 0
    )
    eight_one_beds_broken_bedwars = (
        bedwars_data["eight_one_beds_broken_bedwars"]
        if "eight_one_beds_broken_bedwars" in bedwars_data
        else 0
    )
    eight_one_wins_bedwars = (
        bedwars_data["eight_one_wins_bedwars"]
        if "eight_one_wins_bedwars" in bedwars_data
        else 0
    )
    eight_one_games_played_bedwars = (
        bedwars_data["eight_one_games_played_bedwars"]
        if "eight_one_games_played_bedwars" in bedwars_data
        else 0
    )
    eight_two_final_kills_bedwars = (
        bedwars_data["eight_two_final_kills_bedwars"]
        if "eight_two_final_kills_bedwars" in bedwars_data
        else 0
    )
    eight_two_kills_bedwars = (
        bedwars_data["eight_two_kills_bedwars"]
        if "eight_two_kills_bedwars" in bedwars_data
        else 0
    )
    eight_two_beds_broken_bedwars = (
        bedwars_data["eight_two_beds_broken_bedwars"]
        if "eight_two_beds_broken_bedwars" in bedwars_data
        else 0
    )
    eight_two_wins_bedwars = (
        bedwars_data["eight_two_wins_bedwars"]
        if "eight_two_wins_bedwars" in bedwars_data
        else 0
    )
    eight_two_games_played_bedwars = (
        bedwars_data["eight_two_games_played_bedwars"]
        if "eight_two_games_played_bedwars" in bedwars_data
        else 0
    )
    four_three_final_kills_bedwars = (
        bedwars_data["four_three_final_kills_bedwars"]
        if "four_three_final_kills_bedwars" in bedwars_data
        else 0
    )
    four_three_kills_bedwars = (
        bedwars_data["four_three_kills_bedwars"]
        if "four_three_kills_bedwars" in bedwars_data
        else 0
    )
    four_three_beds_broken_bedwars = (
        bedwars_data["four_three_beds_broken_bedwars"]
        if "four_three_beds_broken_bedwars" in bedwars_data
        else 0
    )
    four_three_wins_bedwars = (
        bedwars_data["four_three_wins_bedwars"]
        if "four_three_wins_bedwars" in bedwars_data
        else 0
    )
    four_three_games_played_bedwars = (
        bedwars_data["four_three_games_played_bedwars"]
        if "four_three_games_played_bedwars" in bedwars_data
        else 0
    )
    four_four_final_kills_bedwars = (
        bedwars_data["four_four_final_kills_bedwars"]
        if "four_four_final_kills_bedwars" in bedwars_data
        else 0
    )
    four_four_kills_bedwars = (
        bedwars_data["four_four_kills_bedwars"]
        if "four_four_kills_bedwars" in bedwars_data
        else 0
    )
    four_four_beds_broken_bedwars = (
        bedwars_data["four_four_beds_broken_bedwars"]
        if "four_four_beds_broken_bedwars" in bedwars_data
        else 0
    )
    four_four_wins_bedwars = (
        bedwars_data["four_four_wins_bedwars"]
        if "four_four_wins_bedwars" in bedwars_data
        else 0
    )
    four_four_games_played_bedwars = (
        bedwars_data["four_four_games_played_bedwars"]
        if "four_four_games_played_bedwars" in bedwars_data
        else 0
    )
    two_four_final_kills_bedwars = (
        bedwars_data["two_four_final_kills_bedwars"]
        if "two_four_final_kills_bedwars" in bedwars_data
        else 0
    )
    two_four_kills_bedwars = (
        bedwars_data["two_four_kills_bedwars"]
        if "two_four_kills_bedwars" in bedwars_data
        else 0
    )
    two_four_beds_broken_bedwars = (
        bedwars_data["two_four_beds_broken_bedwars"]
        if "two_four_beds_broken_bedwars" in bedwars_data
        else 0
    )
    two_four_wins_bedwars = (
        bedwars_data["two_four_wins_bedwars"]
        if "two_four_wins_bedwars" in bedwars_data
        else 0
    )
    two_four_games_played_bedwars = (
        bedwars_data["two_four_games_played_bedwars"]
        if "two_four_games_played_bedwars" in bedwars_data
        else 0
    )
...
async def set_tourney_data(uuid):
    ...
    player_exists = await select_one(
        "SELECT * FROM tournament WHERE uuid = (?)", (uuid,)
    )
    ...
    if player_exists:
        week1_exists = any(
            await select_one(
                "SELECT week1_data FROM tournament WHERE uuid = (?)", (uuid,)
            )
        )
        week2_exists = any(
            await select_one(
                "SELECT week2_data FROM tournament WHERE uuid = (?)", (uuid,)
            )
        )
        week3_exists = any(
            await select_one(
                "SELECT week3_data FROM tournament WHERE uuid = (?)", (uuid,)
            )
        )
...
async def compile_scores(week_number=None):
    ...
    if week_number == 0:
        ...
        for player in players:
            uuid = player[0]
            player_data = await select_one(
                "SELECT recent_data FROM tournament WHERE uuid = (?)", (uuid,)
            )
        ...
        players = await select_all(
            "SELECT uuid, week3_data, week3_end_data FROM tournament"
        )
        for player in players:
            if not player[2]:
                return None
        ...
        players = await select_all(
            f"SELECT uuid, week{week_number}_data, week{week_number + 1} FROM tournament"
        )
        for player in players:
            if not player[2]:
                return None
...
async def get_tournament_stats(
    ...
    if week_number == -1:
        ...
        (
            ...
            w3_fkdr,
            w3_beds_broken,
        ) = await get_points_from_data(week3_stats, current_stats)
        (
            overall_points,
            games_played,
            wins,
        ...
        (
            ...
            w2_fkdr,
            w2_beds_broken,
        ) = await get_points_from_data(week2_stats, current_stats)
        (
            week3_points,
            w3_games_played,
            w3_wins,
        ...
        (
            ...
            w1_fkdr,
            w1_beds_broken,
        ) = await get_points_from_data(week1_stats, current_stats)
    ...
    return {
        "week1": {
            "points": week1_points,
            "games_played": w1_games_played,
            "wins": w1_wins,
            "final_kills": w1_final_kills,
            "beds_broken": w1_beds_broken,
            "wlr": w1_wlr,
            "fkdr": w1_fkdr,
        },
        "week2": {
            "points": week2_points,
            "games_played": w2_games_played,
            "wins": w2_wins,
            "final_kills": w2_final_kills,
            "beds_broken": w2_beds_broken,
            "wlr": w2_wlr,
            "fkdr": w2_fkdr,
        },
        "week3": {
            "points": week3_points,
            "games_played": w3_games_played,
            "wins": w3_wins,
            "final_kills": w3_final_kills,
            "beds_broken": w3_beds_broken,
            "wlr": w3_wlr,
            "fkdr": w3_fkdr,
        },
        "overall": {
