...
class Roles(commands.Cog):
    ...
    async def reaction_roles(self, ctx):
        reaction_roles = discord.Embed(title="To get your desired role, click its respective button!", description="<:sb:732824932177805405> __**SkyBlock**__\n*Gives you the access to the SkyBlock category!*\n\n"
    ...
    async def ticket_embed(self,ctx):
        embed = discord.Embed(title="Tickets",description="Tickets can be created for any of the following reasons:-"
                                                          ...
                                                          "Once you have created your ticket, staff will respond within 24 hours.", color=0x8368ff)
        embed.add_field(name="Do Not Kick List", value="Once you create  the ticket you  will see <@736266884147576903>'s prompts. "
                        ...
                        inline=False)
        embed.add_field(name="Discord Nick/Role/Tag Change", value="Once you create  the ticket you  will see <@736266884147576903>'s prompts. "
                                                                   "Respond to the prompts appropriately.\n"
                                                                   "*If you aren't able to change your tag, it's because you don't meet the tag requirements.",
                        inline=False)
        embed.add_field(name="Problems/Queries/Complaints", value="If you face difficulty in anything, create a ticket! The Miscellaneous Staff Team will gladly help you!",
                        inline=False)
        embed.add_field(name="Player Report", value="When reporting a player, you're expected to explain the situation in maximum detail. Providing the following is considered the bare minimum:-\n"
                        ...
                        inline=False)
        embed.add_field(name="Milestone", value="Upon selection of this category, you'll be prompted by the bot and be asked to give the milestone that you achieved along with proof of its feat. "
                        ...
                        inline=False)
        embed.add_field(name="Staff Application", value="Upon creation, you will be prompted by the bot. After you're done with your application, the Miscellaneous Staff Team will respond within 48 hours.",
                        inline=False)
        embed.set_footer(text="Hit the following button create a ticket!")
        embed.set_thumbnail(url = f"https://images-ext-1.discordapp.net/external/ziYSZZe7dPyKDYLxA1s2jqpKi-kdCvPFpPaz3zft-wo/%3Fwidth%3D671%26height%3D671/https/media.discordapp.net/attachments/523227151240134664/803843877999607818/misc.png")
